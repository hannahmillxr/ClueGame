...
public class BoardAdjTargetTest {
	...
	public void testAdjacencyDoor()
	{
		...
		assertTrue(testList.contains(board.getCell(9, 2)));//room center
		...
		assertTrue(testList.contains(board.getCell(2, 23))); //room center
		
		
		//door down into the scroll room, next to unused space
		testList = board.getAdjList(14, 1);
		assertEquals(3, testList.size());
		assertTrue(testList.contains(board.getCell(18, 1)));//room center
	...
	public void testTargetsInScrollRoom() {
		...
		assertTrue(targets.contains(board.getCell(2, 23)));	
	...
	public void testTargetsOccupied() {
		...
		board.calcTargets(board.getCell(2, 23), 3);
